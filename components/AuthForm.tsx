            ...
            <Link href="/" className="cursor-pointer
                items-center gap-1 flex">
                    <Image
                        ...
                        alt='bank  logo svg'
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Honor</h1>
            </Link>
        ...
        {user ? (
            ...
            <>
                            ...
                            <>  
                                <div className='flex gap-4'>
                                    <CustomFormInput
                                        ...
                                        label = "First Name" placeholder = "ex: Siyabonga"
                                    />

                                    <CustomFormInput
                                        control = {form.control} name = "lastName"
                                        label = "Last Name" placeholder = "ex: Kay"
                                ...
                                <div className='flex gap-4'>
                                    <CustomFormInput
                                        ...
                                        label = "City" placeholder = "ex: Johannesburg"
                                    />
                            
                                    <CustomFormInput
                                        control = {form.control} name = "postalCode"
                                        label = "Postal Code" placeholder = "ex: 1575"
                                    />
                                </div>
                ...
                <footer className="flex justify-center gap-1">
                    <p className="text-14 font-normal tect-gray-600">
